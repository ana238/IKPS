...
plt.tight_layout()
seabornInstance.distplot(podaci['EC'])
plt.show()
...
podaci = pd.DataFrame({'Actual data': yTest, 'Predicted by SVR': yPredict1, 'Predicted by Linear Regression': yPredict2})
podaci1= podaci.head(50)
print(podaci1)
print("\n")

#Točne vrijednosti odstupanja predviđenih od stvarnih vrijednosti za SVR algoritam
...
print("\n")
print("KADA PREDVIĐENA VRIJEDNOST PRELAZI GRANICU OD 300CFU")
print("1. KADA JE STVARNA VRIJEDNOST VEĆA OD PREDVIĐENE:")
...
print("\n")
print("2. KADA JE STVARNA VRIJEDNOST MANJA OD PREDVIĐENE:")
...
#Kada je stvarna vrijednost veća od predviđene 
print("\n")
print("KADA PREDVIĐENA VRIJEDNOST NE PRELAZI GRANICU OD 300CFU")
print("1. KADA JE STVARNA VRIJEDNOST VEĆA OD PREDVIĐENE:")
